# Selefra Provider Zoom

Use this repo as a raw reference to **tables and schema** for Zoom resources. [Here's](https://github.com/selefra/selefra-provider-zoom/blob/main/docs/tables/zoom.md) a summary of full coverage.
